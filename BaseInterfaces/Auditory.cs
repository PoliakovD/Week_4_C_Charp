...
public class NameCoparer : IComparer
{
    public int Compare(object? x, object? y)
    {
        ...
        {
            var studX = x as Student;
            var studY = y as Student;
            
            return studX.FirstName.CompareTo(studY.FirstName);
        }
        throw new ArgumentException("Object is not a Student");
    }
}

public class SurnameCoparer : IComparer
{
    public int Compare(object? x, object? y)
    {
        if (x is Student && y is Student)
        {
            ...
            return studX.LastName.CompareTo(studY.LastName);
        }
        throw new ArgumentException("Object is not a Student");
    }
}